...
HELP_TEXT = (
    ...
    "*AI*\n"
    "• /ask `<question>` — ask about your hours + journal\n"
    "   _e.g._ `/ask which planned activity do I skip most?`\n\n"
    "*Editing & recovery*\n"
    ...
    "• /gaps `[YYYY-MM]` — list hourly slots missing from the Sheet entirely\n"
    "   _(use when /trend totals are short by N hours)_\n"
